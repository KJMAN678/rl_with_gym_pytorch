...
def main():
    ...
    agent_1 = td3(lambda: make_env(ENV_NAME_1))

    if os.path.exists("./videos_1/"):
        shutil.rmtree("./videos_1/")

    save_dir_1 = "./videos_1/pytorch/td3/pendulum/"
    ...
    agent_2 = td3(lambda: make_env(ENV_NAME_2))

    if os.path.exists("./videos_2/"):
        shutil.rmtree("./videos_2/")

    save_dir_2 = "./videos_2/pytorch/td3/pendulum/"
